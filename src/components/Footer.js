      ...
      <div style={{
        ...
        <div className="footer-grid">
          ...
          <div className="footer-links">
            ...
            <ul>
              <li><Link to="/">PG in Koramangala</Link></li>
              <li><Link to="/">PG in HSR Layout</Link></li>
              <li><Link to="/">PG in Whitefield</Link></li>
              <li><Link to="/">PG in Electronic City</Link></li>
              <li><Link to="/">PG near BTM Layout</Link></li>
              <li><Link to="/">PG near Marathahalli</Link></li>
            </ul>
          </div>
